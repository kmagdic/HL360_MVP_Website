...
<a id="pastel-btn" href="https://usepastel.com/link/4rdqr2e3/#/HL360_MVP_Website/" target="_blank" style="position:fixed;bottom:16px;right:16px;background:#111;color:white;padding:8px 10px;border-radius:50%;text-decoration:none;z-index:9999;font-size:15px;line-height:1;box-shadow:0 2px 6px rgba(0,0,0,.3)" title="Leave feedback">💬</a>
<script>if(window.self!==window.top)document.getElementById('pastel-btn').style.display='none';</script>
